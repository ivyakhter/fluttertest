...
class three_D_course extends StatefulWidget {
  @override
  _three_D_coursetate createState() => _three_D_coursetate();
}

class _three_D_coursetate extends State<three_D_course> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
            ...
            title: Text("3D Animation & Visualization")
            ...
            children: <Widget>[
              Row(
                ...
                children: <Widget>[
                  ...
                  Text("3D Animation & Visualization")
                ],
              ),
            ],
          ),*/
  ...
  void initState() {
    ...
    reference.once().then((DataSnapshot snap) {
      ...
      for (var indivisual in KEYS) {
        ...
        if (DATA[indivisual]["course_name"] == "Interior & Exterior Design" ||
            DATA[indivisual]["course_name"] == "3D Animation") {
