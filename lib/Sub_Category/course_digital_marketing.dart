...
class digital_course extends StatefulWidget {
  @override
  _digital_courseState createState() => _digital_courseState();
}

class _digital_courseState extends State<digital_course> {
  @override
  ...
  void initState() {
    ...
    reference.once().then((DataSnapshot snap) {
      ...
      for (var indivisual in KEYS) {
        ...
        if (DATA[indivisual]["course_name"] == "Digital Marketing"
         || DATA[indivisual]["course_name"] == "SEO & Amazon Affiliate Marketing"
       )
        {
