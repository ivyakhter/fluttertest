...
class english_course extends StatefulWidget {
  @override
  _english_courseetate createState() => _english_courseetate();
}

class _english_courseetate extends State<english_course> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          title:Text("English Language Courses")
  ...
  void initState() {
    ...
    reference.once().then((DataSnapshot snap) {
      ...
      for (var indivisual in KEYS) {
        ...
        if (DATA[indivisual]["course_name"] == "Communicative English" ||
            DATA[indivisual]["course_name"] == "Spoken English" ||
            DATA[indivisual]["course_name"] == "Professional English Writing" ||
            DATA[indivisual]["course_name"] == "English Phonetics") {
