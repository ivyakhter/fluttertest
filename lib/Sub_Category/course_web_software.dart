...
class app_web_software extends StatefulWidget {
  @override
  _app_web_softwareState createState() => _app_web_softwareState();
}

class _app_web_softwareState extends State<app_web_software> {
  @override
  ...
  void initState() {
    ...
    reference.once().then((DataSnapshot snap) {
      ...
      for (var indivisual in KEYS) {
        ...
        if (DATA[indivisual]["course_name"] == "Android App Development" ||
            DATA[indivisual]["course_name"] == "Responsive Web Design" ||
            DATA[indivisual]["course_name"] == "Professional Web Development" ||
            DATA[indivisual]["course_name"] == "JavaScript" ||
            DATA[indivisual]["course_name"] == "Python") {
