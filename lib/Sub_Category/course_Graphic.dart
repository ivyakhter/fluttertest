...
class graphics_course extends StatefulWidget {
  @override
  _graphics_courseState createState() => _graphics_courseState();
}

class _graphics_courseState extends State<graphics_course> {
  @override
  ...
  void initState() {
    ...
    reference.once().then((DataSnapshot snap) {
      ...
      for (var indivisual in KEYS) {
        ...
        if (DATA[indivisual]["course_name"] == "Professional Graphic Design"
         || DATA[indivisual]["course_name"] == "Advanced Graphic Design"
            || DATA[indivisual]["course_name"] == "Digital Image Editing"
            || DATA[indivisual]["course_name"] == "UX/UI Design"
            || DATA[indivisual]["course_name"] == "Motion Graphics" )
        {
