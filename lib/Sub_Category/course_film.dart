...
class Film_course extends StatefulWidget {
  @override
  _Film_courseState createState() => _Film_courseState();
}

class _Film_courseState extends State<Film_course> {
  @override
  ...
  void initState() {
    ...
    reference.once().then((DataSnapshot snap) {
      ...
      for (var indivisual in KEYS) {
        ...
        if (DATA[indivisual]["course_name"] == "YouTube Video Making"
          || DATA[indivisual]["course_name"] == "Digital Film Making") {
