...
class Cyber_Security_course extends StatefulWidget {
  @override
  _Cyber_Security_courseState createState() => _Cyber_Security_courseState();
}

class _Cyber_Security_courseState extends State<Cyber_Security_course> {
  @override
  ...
  void initState() {
    ...
    reference.once().then((DataSnapshot snap) {
      ...
      for (var indivisual in KEYS) {
        ...
        if (DATA[indivisual]["course_name"] == "Cyber Security"
