...
class networking_course extends StatefulWidget {
  @override
  _networking_coursetate createState() => _networking_coursetate();
}

class _networking_coursetate extends State<networking_course> {
  @override
  ...
  void initState() {
    ...
    reference.once().then((DataSnapshot snap) {
      ...
      for (var indivisual in KEYS) {
        ...
        if (DATA[indivisual]["course_name"] == "CompTIA A+" ||
            DATA[indivisual]["course_name"] == "CCNA" ||
            DATA[indivisual]["course_name"] == "MikroTik" ||
            DATA[indivisual]["course_name"] == "RED HAT - Linux" ||
            DATA[indivisual]["course_name"] == "Microsoft Windows Server 2016"||
            DATA[indivisual]["course_name"] == "CCNP"
