...
class Dhaka2 extends StatefulWidget {
  @override
  _dhakaState createState() => _dhakaState();
}

class _dhakaState extends State<Dhaka2> {
  @override
            ...
            children: <Widget>[
              ...
              Expanded(
                child: Padding(
                  ...
                  child: Container(
                    decoration: BoxDecoration(),
                    child: Text("info@creativeitinstitute.com",
                        style: TextStyle(fontSize: 18.0)),
                  ),
                ),
              )
          ...
          Row(
            ...
            children: <Widget>[
              Center(
                child: InkWell(
                  onTap: () {
                    goLink("https://www.facebook.com/CreativeITInstitute/");
                  },
                  child: Container(
                    width: 60.0,
                    height: 60.0,
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(
              icon: InkWell(
                  onTap: (){
                    sendMail("info@creativeitinstitute.com");
                  },
