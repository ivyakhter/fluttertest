...
class Ctg extends StatefulWidget {
  @override
  _CtgState createState() => _CtgState();
}
...
class _CtgState extends State<Ctg> {
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          Card(
                            ...
                            child: Container(
                              width:
                                  MediaQuery.of(context).size.width / 8 * 0.8,
                              color: Colors.white,
                              child: Center(
                                child: Icon(
                                  Icons.access_time,
                                            ...
                                            child: Row(
                                              ...
                                              children: <Widget>[
                                                InkWell(
                                                  onTap: () {
                                                    goLink(
                                                        "https://www.facebook.com/CITI.Chattogram");
                                                  },
                                                  child: Container(
                                                    width: 50.0,
                                                    height: 50.0,
              ...
              children: <Widget>[
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Container(
                      decoration: BoxDecoration(),
                      child: Text("ctg@creativeitinstitute.com",
                          style: TextStyle(fontSize: 18.0)),
                    ),
                  ),
                )
            ...
            Row(
              ...
              children: <Widget>[
                Center(
                  child: InkWell(
                    onTap: () {
                      goLink("https://www.facebook.com/CITI.Chattogram");
                    },
                    child: Container(
                      width: 60.0,
                      height: 60.0,
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: [
            ...
            BottomNavigationBarItem(
                icon: InkWell(
                    onTap: (){
                      sendMail("ctg@creativeitinstitute.com");
                    },
  ...
  Future<void> makeCall() async {
    if (await canLaunch("tel:" + "01990779999")) {
      await launch("tel:" + "01990779999");
    }
  }

  Future<void> sendSMS() async {
    if (await canLaunch("sms:" + "01990779999")) {
      await launch("sms:" + "01990779999");
    }
  }
