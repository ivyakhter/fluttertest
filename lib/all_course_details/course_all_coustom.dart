...
class Coustom_course extends StatefulWidget {
  @override
  _Coustom_courseState createState() => _Coustom_courseState();
}

class _Coustom_courseState extends State<Coustom_course> {
  @override
...
/*
        if (DATA[indivisual]["course_name"] == "Advanced Graphic Design"
