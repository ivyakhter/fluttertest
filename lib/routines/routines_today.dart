import 'package:creative_it_flutter_last/component/horizontal_listview.dart';
...
import 'routines_next.dart';

class Routines_Today extends StatefulWidget {
  @override
  _myRoutinesState createState() => _myRoutinesState();
}

class _myRoutinesState extends State<Routines_Today> {
  String day_str;
          ...
          actions: <Widget>[
            FlatButton(
              onPressed: () => Navigator.of(context).push(new MaterialPageRoute(
                  builder: (context) => Routines_Next())),
              child: Text("Next Routine",style: TextStyle(color: Colors.white,fontSize: 20.0, decoration: TextDecoration.underline, decorationStyle: TextDecorationStyle.double),),
            )
          ],
        ),
        body: Column(
